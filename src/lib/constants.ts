...
export const FALLBACK_WINDOWS_URL =
  "https://github.com/KriishT/Tangent/releases/download/v1.0.8/Tangent_1.0.8_x64-setup.exe";
export const FALLBACK_MAC_URL =
  "https://github.com/KriishT/Tangent/releases/download/v1.0.8/Tangent_1.0.8_aarch64.dmg";

...
export const FALLBACK_VERSION = "1.0.7";
export const FALLBACK_WINDOWS_URL =
  "https://github.com/KriishT/Tangent/releases/download/v1.0.7/Tangent_1.0.7_x64-setup.exe";
export const FALLBACK_MAC_URL =
  "https://github.com/KriishT/Tangent/releases/download/v1.0.7/Tangent_1.0.7_aarch64.dmg";
